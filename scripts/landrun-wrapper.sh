...
# Landrun needs one outer `--` before the sandboxed command. Accept either
# form: the pinned Comparator already supplies it, while older callers did
# not. Preserve the separation from lean4export's own `--` separator.
